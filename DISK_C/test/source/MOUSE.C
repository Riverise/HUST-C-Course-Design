...
int my_mouse_press(int ctrx,int ctry,int r)
{
	if     (getdist2(MouseX,MouseY,ctrx,ctry)<=r*r&&press == 1)
		return 1;  //在圆中点击左键，则返回1
		
	else if(getdist2(MouseX,MouseY,ctrx,ctry)<=r*r&&press == 0)
		return 2;  //在圆中未点击，则返回2
		
	else if(getdist2(MouseX,MouseY,ctrx,ctry)<=r*r&&press == 2)
		return 3;  //在圆中点击右键，则返回3
